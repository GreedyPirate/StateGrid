package cn.sina.elec.utils.chart;
...
public class ChartUtils {
	 ...
	 * @Description: 用给定的数据生成柱状图,返回文件路径
	 * @Version: V1.0.0
	 * @Params: 
	 * @Return: String
	 */
	public static String generateBarchart(List<Object[]> data){
		DefaultCategoryDataset dataset = new DefaultCategoryDataset();
		if(data!=null && data.size()>0){
			for (Object[] o : data) {
				//Object[] o中:所属单位,单位名称,人数
		...
		String filename = DateUtils.formattoFile(new Date())+".jpg";
