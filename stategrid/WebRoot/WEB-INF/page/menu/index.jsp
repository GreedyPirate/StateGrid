						...
						<td height="99" width="27%">
							<table border="0" width="70%" id="table4">
								...
								<tr>
									...
									<td>
										<table>
											<tr>
												<td>
													<input type="text" name="checkNumber" id="checkNumber"  maxlength="4" size="7">
												</td>
												<td>
								...
								<tr>
									...
									<td>
										<input type="checkbox" checked="${requestScope.checked }" name="remeberMe" id="remeberMe" value="yes"/>
									</td>
								</tr>
								<tr>
									<td width="100"></td>
