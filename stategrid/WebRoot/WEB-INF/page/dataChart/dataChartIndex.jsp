				...
				<tr>
					...
					<td class="ta_01" >
						<s:select list="#request.jctList" name="projId" id="projId" cssStyle="width:160px"
							listKey="ddlCode" listValue="ddlName" headerKey="" headerValue="全部">
						</s:select>
					</td>
					...
					<td class="ta_01" >
						 <font face="宋体" color="red"> 
					  	<s:select list="#request.picList" name="belongTo" id="belongTo" cssStyle="width:160px"
						listKey="ddlCode" listValue="ddlName" headerKey="" headerValue="全部"></s:select>
					 </font>
					</td>
		     </tr>
		     <tr>
 ...
 <table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
		<tr>
			...
			<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1" style="BORDER-RIGHT:gray 1px solid; BORDER-TOP:gray 1px solid; BORDER-LEFT:gray 1px solid; WIDTH:100%; WORD-BREAK:break-all; BORDER-BOTTOM:gray 1px solid; BORDER-COLLAPSE:collapse; BACKGROUND-COLOR:#f5fafe; WORD-WRAP:break-word">
				...
				<s:if test="#request.fileUploads!=null && #request.fileUploads.size()>0">
					<s:iterator value="#request.fileUploads" status="st">
						<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
							...
							<td align="center"  width="48%">
								<a href="#" onclick="openWindow('${pageContext.request.contextPath }/datachart/elecFileUploadAction_download.do?seqID=<s:property value="seqID"/>','700','400');">
