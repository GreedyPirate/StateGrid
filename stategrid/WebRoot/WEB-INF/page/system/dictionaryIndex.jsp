			...
			<TBODY>
				...
				<tr>
					...
					<td class="ta_01" align="left"  width="30%" >
						<!-- 遍历显示select -->
						<s:select list="#request.typeList" listKey="keyword" listValue="keyword" 
							id="keyword" name="keyword"	headerKey="jerrynew" headerValue=""
							cssClass="bg" cssStyle="width:180px" onchange="changetype()">
						</s:select>
						<!--
						<select id="keyword" name="keyword" class="bg" style="width:180px" onchange="changetype()">
 ...
 <TR height=10><td colspan=3></td></TR>
  <tr>
     <td align="center" colspan=3>
      	<!-- 非管理员用户不能保存数据字典 -->
     	<s:if test="#session.global_popedom.contains('ec')">
