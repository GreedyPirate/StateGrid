		...
		<table cellspacing="1" cellpadding="0" width="90%" align="center"
			...
			<tr>
				<td class="ta_01" colspan="4" align="center"
					background="../images/b-info.gif"><font face="宋体" size="2"><strong>用户信息管理</strong>
				</font></td>
			...
			<tr>
				...
				<td class="ta_01" align="center" bgcolor="#f5fafe" height="22">
					所属单位：</td>
				<td class="ta_01">
					<!-- listKey和listValue分别是option的value属性和innerHTML
							那么就是ddlCode作为listKey,ddlName作为listValue
						 --> <s:select name="jctID" id="jctID" cssStyle="width:155px"
						list="#request.ddlList" listKey="ddlCode" listValue="ddlName"
			...
			<TBODY>
				...
				<tr>
					...
					<input	style="font-size:12px; color:black; height=20;width=80"	id="BT_Add" type="button" value="查询" name="BT_find"
						...
						id="BT_Export" type="button" value="导出" name="BT_Export" onclick="excelExport();">&nbsp;&nbsp;
						
						<input	style="font-size:12px; color:black; height=20;width=80"	id="BT_Export" type="button" value="导入" name="BT_Export"
						onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_importPage.do?belongTo=5-1','700','400')">&nbsp;&nbsp;
						
						<input	style="font-size:12px; color:black; height=20;width=80"	id="BT_Export" type="button" value="查看各单位用户统计" name="BT_Export"
						onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_userChart.do','1024','768')">&nbsp;&nbsp;
						
						<input	style="font-size:12px; color:black; height=20;width=80"	id="BT_Export" type="button" value="查看男女比例" name="BT_Export"
						onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_FCFChart.do','1024','768')">&nbsp;&nbsp;
				</tr>
								...
								<s:iterator value="#request.userList" var="user">
									<tr onmouseover="this.style.backgroundColor = 'white'"
										...
										<td style="HEIGHT:22px" align="center" width="15%"><s:date
												name="#user.onDutyDate" format="yyyy-MM-dd" /></td>
										<td style="HEIGHT:22px" align="center" width="8%"><s:property
												value="#user.postID" /></td>

										<td align="center" style="HEIGHT: 22px" align="center"
											width="10%"><a href="#"
											onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_edit.do?userID=<s:property value='#user.userID'/>','900','700');">
												<img
										...
										<td align="center" style="HEIGHT: 22px" align="center"
											width="10%"><a href="#"
											onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_edit.do?userID=<s:property value='#user.userID'/>&viewflag=1','900','700');">
												<img
