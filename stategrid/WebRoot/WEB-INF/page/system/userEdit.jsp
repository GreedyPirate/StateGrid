...
<html>
  <head>
   ...
   function check_null(){
	...
	function confirmPwd(obj){
		$("#repwd").text("");
		if($("input[name='logonPwd']").val()!=$(obj).val()){
			$("#repwd").html("<font color='red'>两次输入密码不一致</font>");
		}
	}
 ...
 <body>
	 ...
	 <tr>
       ...
       <tr>
         ...
         <td class="ta_01" bgColor="#ffffff">
         	<s:textfield readonly="true" name="logonName" maxlength="25" id="logonName" size="20" onblur="checkUser(this);"></s:textfield>
         </td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select name="sexID" id="sexID" cssStyle="width:155px"
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select name="postID" id="postID" cssStyle="width:155px"
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			...
			onchange="findJctUnit(this)"></s:select>
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:hidden name="md5pwd" value="%{logonPwd}"></s:hidden>
			<s:password  name="logonPwd"  showPassword="true" id="logonPwd" maxlength="25"  size="22"></s:password>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">确认密码：</td>
		<td class="ta_01" bgColor="#ffffff">
			<!-- 注意,栈顶是没有 passwordconfirm的-->
			<s:password value="%{logonPwd}" showPassword="true" name="passwordconfirm" id="logonPwd" maxlength="25"  size="22" onblur="confirmPwd(this)"></s:password>
			<div id="repwd"></div>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<!-- 又想格式化又想显示 -->
			<s:date name="birthday" format="yyyy-MM-dd" var="formattdBirthday"/>
			<s:textfield name="birthday" value="%{formattdBirthday}" id="birthday" maxlength="50"  size="20" onClick="WdatePicker()"></s:textfield>
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<!-- 把value="1" 去了,不然在职查出来也是离职 -->
			<s:select list="#request.isDutyList" name="isDuty"
			listKey="ddlCode" listValue="ddlName" id="isDuty" cssStyle="width:155px"></s:select>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="onDutyDate" format="yyyy-MM-dd" var="formattdOnDutyDate"/>
			<s:textfield name="onDutyDate" value="%{formattdOnDutyDate}" id="onDutyDate" maxlength="50" size="20" onClick="WdatePicker()"></s:textfield>
		</td>
